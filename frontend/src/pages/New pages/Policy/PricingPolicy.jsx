...
import { PricingPolicyData } from "src/Page_Content/PricingPolicyData";
function PricingPolicy() {
  return (
    <div>
      <Helmet>
        <title>Pricing Policy | Transparent Plans at Atlearn</title>
        <meta
          name="description"
          content="Explore Atlearn's flexible pricing plans, billing terms, and refund policy. Choose the right plan to access our all-in-one learning platform today."
        />
        <link rel="canonical" href={`${BASE_URL}/pricing-policy`} />
      </Helmet>
          ...
          <div className="container relative">
            <div className="text-center">
              ...
              <p className="text-size-15md:text-lg text-blackColor dark:text-blackColor-dark font-medium">
                Discover our transparent pricing structure and choose the best
                plan for you.
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto  p-4">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 max-w-8xl w-full">
          <div className="space-y-4">
            {PricingPolicyData.map((section, index) => (
