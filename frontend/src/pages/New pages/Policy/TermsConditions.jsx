...
import { termsSections } from "src/Page_Content/termsConditionsPageData";
function TermsConditions() {
  return (
    <>
         <Helmet>
        <title>Terms and Conditions | Policies for Seamless Learning</title>
        <meta
          name="description"
          content="Review Atlearn's Terms and Conditions to ensure a smooth, secure, and compliant learning experience. Understand our policies for using the platform."
        />
          ...
          <div className="container relative">
            <div className="text-center">
              ...
              <p className="text-size-15md:text-lg text-blackColor dark:text-blackColor-dark font-medium">
                Ensure a seamless learning experience by agreeing to our Terms
                and Conditions.
              </p>
            </div>
          </div>
