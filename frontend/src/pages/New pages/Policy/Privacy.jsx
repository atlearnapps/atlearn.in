...
import { policySections } from "src/Page_Content/privacyPageData";
function Privacy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Your Data Security at Atlearn</title>
        <meta
          name="description"
          content="Learn how Atlearn collects, uses, and protects your data. Read our Privacy Policy for details on security, cookies, and Google data compliance."
        />
        <link rel="canonical" href={`${BASE_URL}/privacy-policy`} />
      </Helmet>
      {/* <Header
        backgroundImage={"/cover_images/privacyPolicy.svg"}
        pageTitle={"Privacy Policy"}
        subTitle={
          "Your data is secure with us. Read our Privacy Policy to learn more."
        }
      /> */}
          ...
          <div className="container relative">
            <div className="text-center">
              ...
              <p className="text-size-15md:text-lg text-blackColor dark:text-blackColor-dark font-medium">
                Your data is secure with us. Read our Privacy Policy to learn
                more.
              </p>
            </div>
          </div>
