...
import TeamIcon from "src/assets/images/Contact/teamIcon.png";
...
function Contact() {
  ...
  return (
    <div>
      <Helmet>
        <title>Contact Us | Get Support & Assistance - Atlearn</title>
        <meta
          name="description"
          content="Reach out to Atlearn for queries or support. Call +91 6381250184 or email support@atlearn.in. We're here to help with all your education needs."
        />
            ...
            <div className="flex flex-col items-center text-center w-full ">
              ...
              <div data-aos="fade-up" className="w-4/5">
                ...
                <p className="text-size-15 md:text-lg text-white  font-medium">
                  Get in touch with us for any questions or support—we're here
                  to help
                </p>
              </div>
            </div>
      ...
      <>
          ...
          <div className="container pb-100px pt-50px">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-30px ">
              <div
                ...
                // action="mail.php"
                // method="post"
                className="lg:col-start-1 lg:col-span-8 space-y-[15px] contact-form p-5  border border-borderColor2 dark:border-transparent dark:shadow-container"
                data-aos="fade-up"
              >
                {/* heading */}
                <div className="mb-0">
              ...
              <div className="lg:col-start-9 lg:col-span-4">
                <div className="grid grid-cols-1   gap-30px ">
                  {/* mail */}
                  <a
                    href="mailto:support@atlearn.in"
                    title="Email us at support@atlearn.in for support"
                  >
                  ...
                  <div
                    onClick={() =>
                      // window.open(
                      //   "https://www.google.com/maps?q=Plot 88B, 2nd Avenue, Vettuvenkkeni, Chennai 600115, India",
                      //   "_blank"
                      // )
                      window.open(
                        "https://teams.microsoft.com/l/chat/0/0?users=contact@akratech.com",
                        "_blank"
                      )
                    }
                    className=" cursor-pointer pt-15px pr-35px pb-25px pl-5 lg:pt-10 lg:pb-10 lg:pl-35px transition-all duration-300 border border-borderColor dark:border-borderColor-dark shadow-address hover:shadow-address-hover hover:-translate-y-5px flex items-center gap-5 lg:gap-30px"
                  >
                    <div>
                      {/* <svg
                        width={46}
                    ...
                    <div className="">
                      ...
                      {/* <p className="text-size-13 lg:text-size-15 text-contentColor dark:text-contentColor-dark leaing-5">
                        Plot 88B, 2nd Avenue, Vettuvenkkeni, Chennai 600115,
                        India
                      </p> */}
                      <p className="text-size-15 text-contentColor dark:text-contentColor-dark leaing-26px">
                        akra.tech
        ...
        {/* <div className="mb-[200px] h-[700px] overflow-hidden">
          <InlineWidget
