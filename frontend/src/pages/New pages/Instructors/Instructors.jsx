...
function Instructors() {
  ...
  return (
    <div>
      <Helmet>
        <title>Discover Atlearn's Expert Instructors and Mentors</title>
        <meta
          name="description"
          content="Learn from Atlearn's expert instructors and mentors. Benefit from their knowledge, guidance, and dedication to your academic success."
        />
        <link rel="canonical" href={`${BASE_URL}/tutors`} />
      </Helmet>
      {/* banner section */}
      <section>
        {/* bannaer section */}
        ...
        <div className="container py-50px ">
          ...
          {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-30px gap-y-15">
            ...
            {tutors?.map((item, index) => (
              <div
                onClick={() => navigate(`/tutor-details?tutor_Id=${item?.id}`)}
                key={index}
                data-aos="fade-up"
                ...
                <div className="text-center">
                  <h5>
                    <Link
                      ...
                      to={`/tutor-details?tutor_Id=${item?.id}`}
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
            {isLoading ? (
              ...
              tutors?.map((user) => {
                ...
                const displayText = truncateText(plainText, 25); // 30 words approx ~3-5 lines
                return (
                  <div
                    onClick={() =>
                    ...
                    key={user.id}
                    className="cursor-pointer bg-white dark:bg-whiteColor-dark dark:text-blackColor-dark rounded-2xl p-5 max-w-md w-full shadow-dropdown-secodary hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between h-full"
                  >
                    <div>
                      <div className="flex items-center gap-4">
                        <img
                    ...
                    {user.description && (
                      <div className="flex justify-end mt-4">
                        <button
                          ...
                          className="text-blue-500 text-sm hover:text-primary hover:bg-white border border-primaryColor px-2 py-1 bg-primaryColor text-whiteColor rounded transition-colors duration-300"
                        >
                          View More
                        </button>
                      </div>
              ...
              <div className="col-span-full text-center text-gray-500 text-lg">
                <div className=" container mt-[100px] mb-[100px] text-center p-10 bg-gray-100 dark:bg-gray-800 rounded-lg">
