...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #F9F9F9;color: #000000">
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                ...
                                <p data-end="182" data-start="85" style="line-height: 140%; margin: 0px;">Great news—we’ve just received a promising lead for a tailored LMS solution through our website! Below are the client’s details:</p>
                                <ul data-end="505" data-start="366">
                                  ...
                                  <li data-end="469" data-start="428" style="line-height: 19.6px;"><strong data-end="446" data-start="430">Phone Number</strong>: ${
                                    phone || "No"
                                  }</li>
  ...
  <!--[if IE]></div><![endif]-->
    ...
    mailOptions = {
      ...
      subject: "Check Out Our New LMS Inquiry",
      html: emailContent,
    };
