...
const FeedbackEmail = async (email, message,name,termsURL,privacyURL) => {
  try {
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                ...
                                <p data-start="701" data-end="723" style="line-height: 140%; margin: 0px;">&nbsp;</p>
                                <p data-start="725" data-end="803" style="line-height: 140%; margin: 0px;">A user has submitted feedback through the Feedback form. Here are the details:</p>
                                <ul data-start="805" data-end="912">
                                  <li data-start="805" data-end="830" style="line-height: 19.6px;"><strong data-start="807" data-end="815">Name</strong>: ${name}</li>
                                  <li data-start="831" data-end="866" style="line-height: 19.6px;"><strong data-start="833" data-end="842">Email</strong>: ${email}</li>
                                  <li data-start="867" data-end="912" style="line-height: 19.6px;"><strong data-start="869" data-end="881">Feedback</strong>:<br data-start="882" data-end="885">${message}</li>
                                </ul>
                                <p data-start="914" data-end="1008" style="line-height: 140%; margin: 0px;">Please review the feedback to identify areas of improvement or address any concerns mentioned.</p>
                              </div>
