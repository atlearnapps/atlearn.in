...
const ContactEmail = async (
  ...
  try {
    const emailUser =
      provider === "Atlearnlms.com"
        ? process.env.LMS_Email_User
        : process.env.Email_User;

    const emailPass =
      provider === "Atlearnlms.com"
        ? process.env.LMS_Email_Password
        ...
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p data-end="274" data-start="252" style="line-height: 140%; margin: 0px;">Dear Atlearn,</p>
                                <p data-end="274" data-start="252" style="line-height: 140%; margin: 0px;">&nbsp;</p>
                                <p data-end="364" data-start="276" style="line-height: 140%; margin: 0px;">You have received a new inquiry through the Contact Us form. The details are as follows:</p>
                                <ul data-end="505" data-start="366">
                                  <li data-end="391" data-start="366" style="line-height: 19.6px;"><strong data-end="376" data-start="368">Name</strong>: ${name}</li>
                                  <li data-end="427" data-start="392" style="line-height: 19.6px;"><strong data-end="403" data-start="394">Email</strong>: ${email}</li>
                                  <li data-end="469" data-start="428" style="line-height: 19.6px;"><strong data-end="446" data-start="430">Phone Number</strong>: ${phone}</li>
                                  <li data-end="505" data-start="470" style="line-height: 19.6px;"><strong data-end="483" data-start="472">Message</strong>:<br data-end="487" data-start="484">${message}</li>
                                </ul>
                                <p data-end="577" data-start="507" style="line-height: 140%; margin: 0px;">Please review and respond to the inquiry at your earliest convenience.</p>
                              </div>
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #6E8AFE;">
              <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:500px;"><tr style="background-color: #6E8AFE;"><![endif]-->
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%; margin: 0px;"><span style="line-height: 19.6px;"><strong>Get in touch</strong></span></p>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%; margin: 0px;"><span style="color: #ffffff; line-height: 19.6px;">Copyright © 2025 by Atlearn. All Rights Reserved.</span></p>
                              </div>
