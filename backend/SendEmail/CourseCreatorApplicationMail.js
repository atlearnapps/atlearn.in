...
const CourseCreatorApplicationMail = async (
  email,
  message,
  name,
  subject,
...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #F9F9F9;color: #000000">
                              ...
                              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="https://assets.unlayer.com/projects/266571/1747636803264-math-101%20(4).png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 88%;max-width: 422.4px;" width="422.4" />
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                ...
                                <p data-end="268" data-start="164" style="line-height: 140%; margin: 0px;">You’ve received a new course creator application through the Atlearn website. Please find the details below:</p>
                                <ul data-start="316" data-end="488">
                                  ...
                                  <li data-start="397" data-end="445" style="line-height: 19.6px;"><strong data-start="399" data-end="415">Phone Number</strong>: ${phone}</li>
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #6e8afe;">
              <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                ...
                <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #6e8afe;width: 500px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                <div class="u-col u-col-100" style="max-width: 320px;min-width: 500px;display: table-cell;vertical-align: top;">
                  <div style="background-color: #6e8afe;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
  ...
  <!--[if IE]></div><![endif]-->
    ...
    mailOptions = {
      ...
      subject: ` Action Needed: Review ${name}’s Course Creator Application`,
      html: emailContent,
    };
...
export default CourseCreatorApplicationMail;
