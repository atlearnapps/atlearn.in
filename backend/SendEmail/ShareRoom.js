...
const ShareRoom = async (email, url, room, termsURL, privacyURL) => {
  try {
    ...
    const termsUrl = termsURL
      ? termsURL
      : `${process.env.CLIENT_URL}/termsconditions`;
    const privacyUrl = privacyURL
      ? privacyURL
      : `${process.env.CLIENT_URL}/privacy`;
    ...
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                              ...
                              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="https://assets.unlayer.com/projects/266571/1747636249973-math-101%20(3).png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 93%;max-width: 446.4px;" width="446.4" />
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="line-height: 140%; margin: 0px;">You have been granted access to a virtual meeting room on Atlearn.</p>
                                <p style="line-height: 140%; margin: 0px;">&nbsp;</p>
                                <p style="line-height: 140%; margin: 0px;">Click the below link to join</p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 19px; color: #3aaee0; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%; margin: 0px;"><strong>${room}</strong></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div align="center">
                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:38px; v-text-anchor:middle; width:480px;" arcsize="10.5%"  stroke="f" fillcolor="#638af5"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                <a href="${url}" target="_blank" class="v-button" style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(99, 138, 245); border-radius: 4px; width: 100%; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 15px; line-height: inherit;"><span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 18px;">Join Your Virtual Meeting&nbsp;</span> <span style="line-height: 18px;">&nbsp;</span> <span style="line-height: 18px;">&nbsp;</span></span>
                                </a>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%; margin: 0px;"><span style="line-height: 19.6px;">Enjoy seamless virtual meetings on Atlearn with interactive tools like screen sharing, real-time collaboration, and high-quality video conferencing.</span></p>
                                <p style="line-height: 140%; margin: 0px;">&nbsp;</p>
                                <p style="line-height: 140%; margin: 0px;"><span style="line-height: 19.6px;">For any assistance, feel free to reach out.</span></p>
                              </div>
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #638af5;">
              <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="width:500px;"><tr style="background-color: #638af5;"><![endif]-->
